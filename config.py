...
COLOR_RADAR_PRIMARY_TRACE = '#808080'
...
COLOR_PAPER_BACKGROUND = 'rgba(0,0,0,5)'
COLOR_PLOT_BACKGROUND = '#F0F0F0'
COLOR_TEXT_PRIMARY = "#1A1A1A"
COLOR_HOVER_LABEL_BACKGROUND = "gray"
...
TEXT_STRINGS = {
    "EN": {
        ...
        "entry_exit_points_legend_label": "Key Locations", # For heatmap legend
